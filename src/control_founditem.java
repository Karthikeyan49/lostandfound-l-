...
public class control_founditem{
   static  String temp=null;
    ...
    void register_button(ActionEvent event) throws Exception {
        ...
        String s="insert into founditem values('" + Item_name_textfield.getText() + "','" + Category_choicebox.getValue() + "','" + Lost_date_textfield.getText()
