...
public class control_foundpage {
    ...
    void initialize() throws Exception {
        ...
        s = "select *from founditem order by id desc";
        setresultset();
    }
    ...
    @FXML
    void onverify(ActionEvent event) throws Exception {
        str = rs.getString("email");
        id = rs.getInt("id");
        ob.openfile("verification");
    }
    ...
    void refreshaction(ActionEvent event) throws Exception {
        ...
        if (!(category.getValue() == null) && !(fromdate.getValue() == null)
            ...
            s = "select *from founditem where (catagory='" + category.getValue() + "') and (lostdate between  '"
            ...
            s = "select *from founditem where catagory='" + category.getValue() + "' order by id desc";
            setresultset();
        } else if (!(fromdate.getValue() == null) && !(tilldate.getValue() == null) && category.getValue() == null) {
            s = "select *from founditem where lostdate between '" + fromdate.getValue() + "' and '"
                    + tilldate.getValue()
                    + "' order by id desc";
            setresultset();
        }
